...
function Header({placeholder}) {
    ...
    return (
        ...
        {/*logo section*/}
                    <div onClick={() => router.push('/')} className="relative Navbar__logo-wrapper flex items-center h-10 cursor-pointer my-auto">
                            <Image 
        ...
        {/*search section*/}
                    ...
                    <div className="Navbar__user-wrapper flex items-center justify-end space-x-4 text-gray-400">
                    ...
                    {searchInput && (
                        ...
                        <div className="flex items-center border-b mb-4">
                            ...
                            min={1} 
                            type="number" 
                            className='w-12 pl-2text-lg outline-none text-red-400'/>
                        </div>
                        <div className='flex'>
